...
bool fixed_epsilon = getEnvBool("RL_FIXED_EPSILON", false); // Use fixed epsilon value if true, slope function if false
...
int num_training_runs = getEnvInt("RL_NUM_RUNS", 40);          // Number of runs to perform
